...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-gradient-to-b from-card to-background shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] text-card-foreground flex flex-col gap-4 rounded-xl border py-6",
        className
      )}
      {...props}
    />
